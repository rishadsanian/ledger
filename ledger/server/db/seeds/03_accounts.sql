...
VALUES
    -- Assets
    ('Cash', '1001', 5000.00, 'Debit', 10, 1, '10-1001'),
    ('Accounts Receivable', '1002', 3000.00, 'Debit', 10, 1, '10-1002'),

    -- Liabilities
    ('Accounts Payable', '2001', 2000.00, 'Credit', 20, 1, '20-2001'),
    ('Loan Payable', '2002', 5000.00, 'Credit', 20, 1, '20-2002'),

    -- Revenue
    ('Sales', '3001', 10000.00, 'Credit', 30, 1, '30-3001'),

    -- Expense
    ('Rent Expense', '4001', 1000.00, 'Debit', 40, 1, '40-4001'),
    ('Utilities Expense', '4002', 500.00, 'Debit', 40, 1, '40-4002'),

    -- Equity
    ('Owner''s Equity', '5001', 0.00, 'Credit', 50, 1, '50-5001');
