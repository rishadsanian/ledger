      ...
      <div className="mb-6">
        ...
        {companyInfo.listed && (
          <div className="text-md text-gray-500 mb-2 flex items-center">
            ...
            <div className={`ml-2 flex items-center ${companyInfo.stock.tickerChangePrice >= 0 ? "text-green-500" : "text-red-500"}`}>
  <span className="">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 mb-6">
        <div className="bg-white p-4 rounded shadow">
          ...
          <p className="text-green-500">
            ${incomeData.reduce((total, data) => total + data.amount, 0)}
          </p>
        </div>
        <div className="bg-white p-4 rounded shadow">
          <h2 className="text-xl font-bold mb-2">Total Expenses</h2>
          <p className="text-red-500">
            ${expensesData.reduce((total, data) => total + data.amount, 0)}
          </p>
        </div>
      </div>
